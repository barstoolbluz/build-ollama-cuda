{ ollama-cuda, autoPatchelfHook, fetchFromGitHub, buildGoModule }:

# Build Ollama v0.12.11 with CUDA support
# This version branch builds a specific ollama version (v0.12.11)
