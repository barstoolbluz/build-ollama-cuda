...
let
  ...
  # MODIFIED: No LD_LIBRARY_PATH wrapper for CUDA - trust Flox's LD_AUDIT to redirect libcuda.so.1
  wrapperOptions = [
  ]
  ...
  # Removed: CUDA LD_LIBRARY_PATH addition - let LD_AUDIT handle it
